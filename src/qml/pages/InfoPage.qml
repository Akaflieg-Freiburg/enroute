    ...
    SwipeView {
        ...
        ScrollView {
            ...
            Item {
                ...
                NightAndDayLabel {
                    id: lbl1
                    nightAndDayText: librarian.getStringFromRessource(":text/info_enroute.html")
        ...
        ScrollView {
            ...
            Item {
                ...
                NightAndDayLabel {
                    id: lbl2
                    nightAndDayText: librarian.getStringFromRessource(":text/authors.html")
                    textFormat: Text.RichText
                    width: pg.width
                    wrapMode: Text.Wrap
                    topPadding: Qt.application.font.pixelSize*1
        ...
        ScrollView {
            ...
            Item {
                ...
                NightAndDayLabel {
                    id: lbl3
                    nightAndDayText: librarian.getStringFromRessource(":text/info_license.html")
                    textFormat: Text.RichText
                    width: pg.width
                    wrapMode: Text.Wrap
                    topPadding: Qt.application.font.pixelSize*1
