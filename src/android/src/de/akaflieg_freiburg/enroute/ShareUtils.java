 ...
 * classes.
 *
 * Both classes need to use the same OPEN_REQUEST_CODE. Both classes need to use
 * the same SAVE_REQUEST_CODE. IntenLauncher stores the share URI by
 * setShareUri() which later be retreived by ShareActivity unsing getShareUri.
 */
public class ShareUtils 
{
    ...
    /**
     * should be set by IntentLauncher.saveFile just before the intent is
     * launched.
     */
    ...
    /**
     * used bye ShareActivity.onActivityResult to get source URI for saving
     * file.
     */
