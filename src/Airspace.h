...
public:
     ...
     *
     * This method gives a rought estimate for the lower limit of the airspace in ft MSL. The result is not reliable enough for aviation purposes but can be used to sort the airspaces in the GUI.
     */
    double estimatedLowerBoundInFtMSL() const;

    /*! \brief Estimates if the airspace begins at FL100 or above
     *
     * If the lower limit string cannot be interpreted or if the lower limit is not given as a flight level, then this method returns 'false'.
     */
    ...
    /*! \brief QGeoPolygon that describes the airspace */
