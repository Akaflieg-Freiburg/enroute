...
Item {
    ...
    Connections {
        ...
        function onRequestShowSideView(show) {
            if (show)
                rawSideView.Layout.preferredHeight = page.height/3
            else
                rawSideView.Layout.preferredHeight = 0
        }
    }
    ...
    ColumnLayout {
        ...
        Item {
            ...
            Layout.fillWidth: true
            Layout.minimumHeight: gridView.implicitHeight
            ...
            GridLayout {
                ...
                ColumnLayout {
                    ...
                    MapButton {
                        ...
                        visible: rawSideView.Layout.preferredHeight < 100
                        autoRepeat: true
        ...
        Rectangle {
            ...
            color: T.SplitHandle.pressed ? Material.background : Qt.lighter(Material.background, T.SplitHandle.hovered ? 1.2 : 1.1)
            DragHandler {
                target: null
                onActiveTranslationChanged: (delta) => rawSideView.resizeHeight(delta.y)
            }
        ...
        Sideview {
            ...
            Layout.maximumHeight: colLy.height-remainingRoute.height-navBar.height-mapLY.Layout.minimumHeight

            pixelPer10km: flightMap.pixelPer10km

            function resizeHeight(delta) {
                if (Layout.preferredHeight - delta < 0) {
                    Layout.preferredHeight = 0
                    return
                }
                Layout.preferredHeight -= delta
            }
            DragHandler {
                target: null
                onActiveTranslationChanged: (delta) => rawSideView.resizeHeight(delta.y)
