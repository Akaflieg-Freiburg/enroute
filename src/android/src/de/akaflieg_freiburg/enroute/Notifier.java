...
public class Notifier {
    ...
    public static void hideNotification(int id) {
        m_notificationManager = (NotificationManager) QtNative.activity()
    ...
    public static void showNotification(int id, String title, String text, String longText, String actionText) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            ...
            switch (id) {
                case 0:
                    notificationChannel = new NotificationChannel("info", "Information",
                            NotificationManager.IMPORTANCE_LOW);
                    break;
                case 1:
                case 2:
                    notificationChannel = new NotificationChannel("error", "Error Message",
                            NotificationManager.IMPORTANCE_HIGH);
                    break;
                case 3:
                    notificationChannel = new NotificationChannel("update", "Update",
                            NotificationManager.IMPORTANCE_HIGH);
                    break;
            }
        ...
        PendingIntent pendingIntent = PendingIntent.getBroadcast(QtNative.activity(), 0, notificationIntent,
