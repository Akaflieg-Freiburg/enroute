...
public:
     ...
     *
     * This property holds the wind direction. This is a number that lies in the interval [minWindDirection, maxWindDirection] or NaN if no value has been set.
     */
    ...
    /*! \brief Setter function for property of the same name
     *
     * This method saves the new value in a QSetting object. If windDirection is outside of the interval [minWindDirection, maxWindDirection], the property will be set to NaN.
     */
