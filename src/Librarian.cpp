...
%1
    ...
    if (name == u"sideView"_s)
    {
        return  u"<p>"_s +
               ...
               u"</p><p>"_s +
               tr("<a href='https://akaflieg-freiburg.github.io/enrouteManual/forward.html#staticpressure'>Consult the manual</a> for more information and for possible solutions.") +
               u"</p>"_s;
    }
